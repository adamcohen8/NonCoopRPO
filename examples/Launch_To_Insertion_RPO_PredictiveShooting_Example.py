...
# Allow running this file directly: `python examples/Launch_To_Insertion_RPO_PredictiveShooting_Example.py`
...
def main() -> None:
    ...
    rocket = Rocket(
        ...
        predictive_update_period_s=8.0,
        predictive_horizon_s=360.0,
    ...
    print("Guidance mode:", rocket.guidance_mode)
